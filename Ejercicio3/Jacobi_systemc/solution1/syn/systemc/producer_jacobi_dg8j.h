...
// ==============================================================
#ifndef __producer_jacobi_dg8j__HH__
#define __producer_jacobi_dg8j__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(producer_jacobi_dg8j) {
    ...
    SC_CTOR(producer_jacobi_dg8j):  ACMP_dadddsub_U ("ACMP_dadddsub_U") {
