# ==============================================================
# File generated on Thu Jun 27 09:36:08 +0200 2019
...
HLS_SOURCES = ../../../main.cpp ../../../software.cpp ../../../hardware.cpp ../../../fsm.cpp
...
$(ObjDir)/fsm.o: ../../../fsm.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../fsm.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/fsm.d
