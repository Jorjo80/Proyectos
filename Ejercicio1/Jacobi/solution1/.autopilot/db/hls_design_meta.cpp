...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("J_address0", 4, hls_out, 0, "ap_memory", "mem_address", 1),
	Port_Property("J_ce0", 1, hls_out, 0, "ap_memory", "mem_ce", 1),
	Port_Property("J_q0", 32, hls_in, 0, "ap_memory", "mem_dout", 1),
	...
	Port_Property("error", 64, hls_in, 5, "ap_none", "in_data", 1),
};
